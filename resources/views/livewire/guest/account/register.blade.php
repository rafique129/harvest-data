...
<div>
    ...
    <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Sign up to your account
    </h2>

</div>
<form class="mt-8 space-y-4" wire:submit.prevent='attemptRegister'>
    ...
    <div class="flex items-center justify-between">
        <label for="remember-me" class=" block text-sm text-gray-900"> Already have account ? <a href="{{route('guest.account.login')}}" class="text-indigo-600 font-medium">Sign In</a>
        </label>
    </div>
